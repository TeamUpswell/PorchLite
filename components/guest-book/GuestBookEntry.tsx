    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="p-6 border-b border-gray-100">
        <div className="flex items-start justify-between">
          ...
          <button
            aria-label={
              showFullContent ? "Show less content" : "Show more content"
            }
      ...
      <div className="p-6">
                ...
                {entry.photos.map((photo, index) => (
                  ...
                  >
                    <Image
                      src={photo}
                      alt={
                        entry.photo_captions?.[index] || `Photo ${index + 1}`
                      }
                      fill
        ...
        {/* Recommendations */}
        {entry.guest_recommendations &&
          entry.guest_recommendations.length > 0 &&
          (isExpanded || showFullContent) && (
            <div className="mb-6">
              <h5 className="text-sm font-medium text-gray-900 mb-3 flex items-center">
                    ...
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        <h6 className="font-medium text-gray-900 flex items-center">
                          <span className="mr-2">
                            {getCategoryIcon(rec.recommendation.category)}
                          </span>
              ...
              <div className="bg-green-50 border border-green-200 rounded-lg p-3">
                ...
                <div className="space-y-1 text-sm text-green-700">
                  {entry.everything_was_great && (
                    <p>
                      ✨ No issues with the property - everything was great!
                    </p>
                  )}
          ...
          <div className="flex items-center space-x-4 text-sm text-gray-500">
            ...
            {entry.guest_recommendations &&
              entry.guest_recommendations.length > 0 && (
                <span className="flex items-center">
                  <MapPin className="h-4 w-4 mr-1" />
                  {entry.guest_recommendations.length} recommendation
                  {entry.guest_recommendations.length !== 1 ? "s" : ""}
                </span>
              )}
            {(entry.everything_was_great || entry.everything_well_stocked) && (
