    ...
    if (task) {
      setEditTask({
        ...
        recurring_end_date: task.recurring_end_date
          ? task.recurring_end_date.split("T")[0]
          : "",
      });
  ...
  const handleUpdateTask = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const taskData = {
        ...
        recurrence_pattern: editTask.is_recurring
          ? editTask.recurrence_pattern
          : null,
        recurrence_interval: editTask.is_recurring
          ? editTask.recurrence_interval
          : null,
        recurring_end_date:
          editTask.is_recurring && editTask.recurring_end_date
            ? editTask.recurring_end_date
            : null,
            ...
            {editTask.is_recurring && (
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                <p className="text-sm text-blue-800">
                  ℹ️ This is a recurring task. Changes will only apply to this
                  instance.
                </p>
              </div>
            )}
