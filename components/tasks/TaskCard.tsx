...
export default function TaskCard({
  ...
  const canComplete =
    (isAssignedToMe || canClaim) && task.status !== "completed";
  ...
  return (
    <div
      className={`bg-white rounded-xl border-l-4 ${priorityConfig.border} border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden`}
    >
      ...
      <div className="p-4 pb-0">
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center gap-2 flex-wrap">
            <span
              className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium border ${statusConfig.badge}`}
            >
              <StatusIcon className="w-3 h-3 mr-1" />
              {statusConfig.text}
            </span>
            <span
              className={`inline-flex items-center px-2 py-1 rounded-md text-xs font-medium ${priorityConfig.badge}`}
            >
        ...
        {dueDateStatus && (
          <div
            className={`inline-flex items-center px-3 py-1.5 rounded-lg text-sm font-medium mb-3 ${dueDateStatus.bg} ${dueDateStatus.color}`}
          >
        ...
        <div className="flex items-center justify-between text-sm text-gray-600 mb-3">
          ...
          <div className="text-xs text-gray-500">by {task.created_by_name}</div>
