            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-gray-700">
                  Everything you need for a perfect getaway. Take a virtual walkthrough
                  or browse our available gear and amenities.
                </p>
              </div>
        ...
        <StandardCard title="House Features">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center p-4">
              ...
              <div className="text-sm text-gray-500">Password in welcome book</div>
            </div>
            ...
            <div className="text-center p-4">
              ...
              <div className="text-sm text-gray-500">Netflix, Hulu included</div>
            </div>
