    ...
    return (
      <StandardCard>
        <div className="text-center py-12">
          ...
          <div className="text-xs text-gray-400 bg-gray-50 dark:bg-gray-800 rounded p-3 inline-block">
      ...
      >
        {loading ? (
          <div className="flex items-center justify-center py-12">
            ...
            <span className="ml-2 text-gray-600 dark:text-gray-400">Loading checklists...</span>
          </div>
        ) : checklists.length === 0 ? (
          <div className="text-center py-12">
