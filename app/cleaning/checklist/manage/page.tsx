...
export default function ManageCleaningChecklistPage() {
    ...
    return (
      <StandardCard>
        <div className="text-center py-12">
          ...
          <div className="text-xs text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800 rounded p-3 inline-block">
  ...
  const checklistTips = [
    ...
    "Create templates for common cleaning scenarios",
    "Review and update checklists regularly for efficiency",
  ];
  ...
  return (
    <div className="space-y-6">
                ...
                <Link
                  ...
                  className={`flex items-center py-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap ${
                    isActive
                      ...
                      : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 dark:text-gray-600 dark:text-gray-400 dark:hover:text-gray-300"
                  }`}
                >
                  <IconComponent
        ...
        <form onSubmit={createChecklist} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500  text-gray-900 dark:text-gray-100"
      ...
      <StandardCard
        ...
        subtitle={`${checklists.length} checklist${
      ...
      >
        {loading ? (
          ...
          <div className="text-center py-12">
            <ClipboardList className="h-12 w-12 text-gray-600 dark:text-gray-400 mx-auto mb-4" />
            <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">
              No Checklists Yet
            </h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    {editingChecklist?.id === checklist.id ? (
                      <form onSubmit={updateChecklist} className="space-y-4">
                        <input
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-3">
            {checklistTips.slice(0, 3).map((tip, index) => (
          ...
          <div className="space-y-3">
            {checklistTips.slice(3).map((tip, index) => (
      ...
      <StandardCard
        title="Quick Actions"
        subtitle="Common checklist management tasks"
      >
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="flex items-center p-4  rounded-lg">
            <ClipboardList className="h-8 w-8 text-green-600 mr-3 flex-shrink-0" />
            <div>
              <h4 className="font-medium text-gray-900 dark:text-gray-100">
                Import Checklist
              </h4>
          ...
          <div className="flex items-center p-4  rounded-lg">
            <Settings className="h-8 w-8 text-purple-600 mr-3 flex-shrink-0" />
            <div>
              <h4 className="font-medium text-gray-900 dark:text-gray-100">
                Bulk Operations
              </h4>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className=" rounded-lg max-w-md w-full p-6">
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-6">
              Are you sure you want to delete '{checklistToDelete?.name}'? This
              will also delete all items in this checklist. This action cannot
              be undone.
            </p>
